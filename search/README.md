...
```toml
[[imports]]
path = "github.com/ziyooren/hugo-modules/search"
```
...
```html
[[params.plugins.js]] link = "js/search.js"
```
...
| :-----------: | :-----------: |
| ![image](https://github.com/ziyooren/hugo-modules/assets/87603786/daf67039-f84c-4799-95b8-4d647e0f535f) | ![image](https://github.com/ziyooren/hugo-modules/assets/87603786/84ab4cc1-e8fd-460c-95f1-e5432b8b792b) |
